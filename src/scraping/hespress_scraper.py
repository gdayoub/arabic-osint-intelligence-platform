"""Hespress (Morocco) Arabic scraper implementation."""
...
class HespressScraper(BaseScraper):
    ...
    def __init__(self, settings: Settings | None = None):
        ...
        super().__init__(
            ...
            start_urls=app_settings.hespress_seed_urls or [
    ...
    def is_valid_listing_url(self, listing_url: str) -> bool:
        ...
        return not parsed.netloc or parsed.netloc in ("www.hespress.com", "hespress.com")
